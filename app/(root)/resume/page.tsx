  ...
  return (
    <div className="grid gap-x-8 gap-y-8 px-4 py-16 sm:px-8 lg:grid-cols-3 lg:px-16">
      ...
      <div className="flex flex-col gap-y-8 lg:col-span-2">
        ...
        <Card icon={resumeData.courseSectionData.icon} title={resumeData.courseSectionData.title}>
      ...
      <div className="flex flex-col gap-y-8">
        {/* For Recruiter */}
        <Card icon={resumeData.forRecruiterData.icon} title={resumeData.forRecruiterData.title}>
          <ForRecruiter faq={resumeData.forRecruiterData.faq} />
        </Card>

        {/* Download Resume */}

        <Card icon={resumeData.downloadResumeData.icon} title={resumeData.downloadResumeData.title}>
          <CardItem>
            <DownloadResume downloadResume={resumeData.downloadResumeData.downloadResume} />
          </CardItem>
        </Card>

        {/* Skills */}
        <Card icon={resumeData.skillsData.icon} title={resumeData.skillsData.title}>
        ...
        {/* Contact */}
        <Card icon={resumeData.contactData.icon} title={resumeData.contactData.title}>
        ...
        {/* Youtube */}
        <Card icon={resumeData.youTubeSectionData.icon} title={resumeData.youTubeSectionData.title}>
